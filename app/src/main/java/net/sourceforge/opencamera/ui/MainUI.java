        ...
        main_activity.runOnUiThread(new Runnable() {
            public void run() {
                ...
                if( MainActivity.SIMPLE_UI ) {
                    ...
                    if( switchMultiCameraButton != null ) switchMultiCameraButton.setVisibility(View.GONE);
                }
                if( MyDebug.LOG ) {
        ...
        main_activity.runOnUiThread(new Runnable() {
            public void run() {
                ...
                if( MainActivity.SIMPLE_UI ) {
                    ...
                    switchCameraButton.setVisibility(View.GONE);
                    if( switchMultiCameraButton != null ) switchMultiCameraButton.setVisibility(View.GONE);
                    View scTakePhoto = main_activity.findViewById(R.id.take_photo);
                    if( scTakePhoto != null ) scTakePhoto.setVisibility(View.GONE);
                    View scGallery = main_activity.findViewById(R.id.gallery);
                    if( scGallery != null ) scGallery.setVisibility(View.GONE);
                }
